...
Benchmarks = [
    ...
    // loop iterations
    new Benchmark("Fast Loops x 1,000,000", [
    ...
    // variable access
    new Benchmark("Variable access x 1,000,000", [
    ...
    // recycling matrices
    new Benchmark("Identity matrix x 1,000,000", [
    ...
    // array FP
    new Benchmark("Array iteration x 1,000,000", [
    ...
    // matrix math
    new Benchmark("Matrix by vector x 10,000", [
    ...
    // string splitting
    new Benchmark("String splitting x 10,000 (moderate)", [
